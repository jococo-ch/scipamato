...
// Refs:
:url-repo: https://github.com/jococo-ch/scipamato/
...
{url-cl}2.3.0++...++2.3.1[Full Changelog]

.Changed
- Bumped spring-boot, feign, jasperreports, wicket, wicketstuff,
  kotlin,
  logback, guava, jooq, bouncycastle
  gradle,
  kotest,
  github actions checkout, setup-java, login, codeql, gradle, sonarqube

.Fixed
- {url-issues}231[#231] Restore code coverage n SonarCloud


[[v2.3.0]]
== {url-tree}2.3.0[2.3.0] -- 2026-07-12

{url-cl}2.2.1++...++2.3.0[Full Changelog]

.Changed
- Bumped spring-boot, kotlin, spring-cloud, feign, spring-boot-admin,
  jOOQ, KRis, bouncycastle,
  gradle,
  kotest,
  actions/cache, actions/checkout, actions/setup-java, docker/login-action, gradle/actions
...
[[v2.2.1]]
== {url-tree}2.2.1[2.2.1] -- 2026-06-11

{url-cl}2.2.0++...++2.2.1[Full Changelog]

.Fixed
- Restore ability to start SciPaMaTo-core using
  java -jar (unbreaking JasperReport compilation)


[[v2.2.0]]
== {url-tree}2.2.0[2.2.0] -- 2026-06-11

{url-cl}2.1.14++...++2.2.0[Full Changelog]

.Changed
- Bumped spring-boot, spring-boot-admin, spring-cloud-starter, spring-mockk,
  wicket, wicket-spring-boot-starter, wicketstuff, jasperreports,
  kotlin-logging, lombok, postgresql,
  kotlinx-coroutines,
  mockk, jacoco,
  gradle,
  gradle license-plugin, sonarqubeplugin,
  checkout action, gradle action, codeql-action
- migrated from undertow to tomcat
- upgraded postgres from 15.4 to 17.4


[[v2.1.14]]
== {url-tree}2.1.14[2.1.14] -- 2026-04-24

{url-cl}2.1.13++...++2.1.14[Full Changelog]

.Changed
- Bumped spring boot, spring-cloud-dependencies, spring-cloud-starter-openfeign, feign,
  kotlin, lombok, guava,
  ehcache,
  kotest, jacoco, equalsverifier, dependency-license-report,
  gradle-actions, codeql-action, login-action, upload-artifiact and cache actions


[[v2.1.13]]
== {url-tree}2.1.13[2.1.13] -- 2026-03-24

{url-cl}2.1.12++...++2.1.13[Full Changelog]

.Changed
- Bumped spring-boot, kotlin-logging,
  gradle github actions, codeql-action


[[v2.1.12]]
== {url-tree}2.1.12[2.1.12] -- 2026-03-24

{url-cl}2.1.11++...++2.1.12[Full Changelog]

.Changed
- Moved from github.com/ursjoss to github.com/jococo-ch/
- Bumped spring-boot, spring-cloud, feign
  spring-boot-admin-starter-client, gradle, postgresql,
  kotest, equalsverifier,
  commons-compress, commons-lang3, commons-fileupload,
  sonarqube, upload-artifact-action, login-action, codeql-action, gradle-actions
